...
public class JdbcTimeOffRequestsDao implements TimeOffRequestsDao {
    ...
    public List<TimeOffRequests> getAllTimeOffRequests() {
        ...
        String sql = "SELECT * FROM time_off_requests ORDER BY request_date DESC, request_id DESC";
    ...
    public List<TimeOffRequests> getAllTimeOffRequestsByUsername(String username) {
       List <TimeOffRequests> timeOffRequests = new ArrayList<>();
        String sql = "SELECT * FROM time_off_requests JOIN users ON time_off_requests.user_id = users.user_id WHERE users.username = ? ORDER BY request_date DESC, request_id DESC";
    ...
    public List<TimeOffRequests> getAllTimeOffRequestsByUserId(int id) {
        List <TimeOffRequests> timeOffRequests = new ArrayList<>();
        String sql = "SELECT * FROM time_off_requests JOIN users ON time_off_requests.user_id = users.user_id WHERE users.user_id = ? ORDER BY request_date DESC, request_id DESC";
