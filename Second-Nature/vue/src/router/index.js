...
import EmployeeTimeStampView from '../views/TIME-STAMP/EmployeeTimeStampView.vue';
/**
...
const routes = [
  ...
  {
    path: '/maintenance-ticket-list/equipment/:equipmentId',
    name: 'equipment-maintenance-ticket-list',
    component: EquipmentMaintenanceTicketsView,
    meta: {
      requiresAuth  : true
    }
  },
  ...
  },
  {
    ...
    component: EmployeeTimeStampView,
    meta: {
      requiresAuth: false
    }
